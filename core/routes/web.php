...
Route::post('/payment/icash', [\App\Http\Controllers\Gateway\Icash\IcashController::class, 'handlePayment']);
// User Support Ticket
...
Route::controller('SiteController')->group(function () {
    ...
    Route::post('ipn/icash', [App\Http\Controllers\Gateway\IcashController::class, 'handleIPN'])->name('ipn.icash');
